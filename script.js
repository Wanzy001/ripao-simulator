(function () {
  ...
  const I18N = {
    zh: {
      ...
      genderTitle: "选择视角",
      genderSubtitle: "仅影响本局约会对象性别，不收集个人信息。",
      maleRole: "男性视角",
      femaleRole: "女性视角",
      desireLabel: "🔥 生理欲望",
      loadLabel: "🧠 心理负荷",
      ...
      helpTitle: "玩法说明",
      winTitle: "目标",
      winRule1: "把生理欲望降到 0，可以获得胜利。",
      winRule2: "正确识别高风险对象并礼貌离开，会计入“正确离开”。",
      loseTitle: "失败",
      loseRule1: "生理欲望到 100 会失控失败；第一次会触发一次理智拉回。",
      ...
      fieldTestRiskToast: "现场测试结果可疑，你提前识别了风险",
      ...
      judgmentCorrectLeave: "你识别到了可疑风险并及时离开，心理负荷下降，这次不是亏。",
    ...
    en: {
      ...
      genderTitle: "Choose perspective",
      genderSubtitle: "Only affects date gender for this run. No personal information is collected.",
      maleRole: "Male perspective",
      femaleRole: "Female perspective",
      ...
      skipAction: "Politely leave",
      skipMeta: "Skip this date",
      refuseAction: "",
      ...
      introLine3: "Not every date has disease clues. More clues mean more risk judgment. Clarifying, tests, and clinic checks reveal information but have costs.",
      startButton: "Start",
      helpButton: "Detailed rules",
      helpTitle: "How to play",
      winTitle: "Goal",
      winRule1: "Reduce physical desire to 0 to win.",
      winRule2: "Correctly identifying and leaving a high-risk date counts as a correct leave.",
      loseTitle: "Failure",
      loseRule1: "Desire at 100 causes loss of control. The first time triggers one rational pullback.",
      ...
      panicHidden: "",
      probeUnavailable: "Not a good moment to ask more",
      ...
      fieldTestRiskToast: "The on-site test looks suspicious. You spotted risk early.",
      ...
      hospitalToast: "Clinic check: desire +15, mental load cleared",
      probeTitle: "Another detail slipped out",
      probeMessage: "They added one more detail. It is clearer, but not exactly calming.",
      calmBoostReady: "Two correct judgments in a row unlocked a calm bonus: the next clarification only adds +1 desire.",
      calmBoostUsed: "Calm bonus used: this clarification only added +1 desire.",
      healthyRewardNote: "Obviously healthy date + safer choice: comfort kicked in, reducing desire and mental load further.",
      correctStreakNote: "Two correct judgments in a row unlocked a calm bonus: the next clarification raises desire less.",
      desireGuardNote: "Rational pullback triggered: the first desire overflow did not end the run, and desire dropped back to 85.",
      desireGuardToast: "Rational pullback triggered: desire dropped back to 85. One time only.",
      ...
      noneValue: "None",
      rationalEnjoy: "Rational enjoyment",
      ...
      clueExplainLabel: "Clue explanation",
      ...
      judgmentCorrectLeave: "You spotted suspicious risk and left in time. Mental load dropped, and this was not a loss.",
  ...
  const STATIC_TRANSLATIONS = {
    en: {
      ...
      "最近熬夜，精神不太好": "Recently stayed up late and looks low-energy",
      "健身后肌肉酸痛": "Muscle soreness after working out",
      "换季嗓子不舒服": "Throat feels off from seasonal change",
      "吃辣后口腔破了一点": "Spicy food left a small mouth sore",
      "工作压力大，看起来很疲惫": "Work stress makes them look tired",
      "出差回来作息乱": "Just returned from a trip and sleep schedule is messy",
      "皮肤有点过敏": "Skin seems a little allergic",
      "最近减脂，体重下降": "Recently dieting and lost weight",
      "换了新护肤品，脸颊有点泛红": "New skincare product made cheeks a bit red",
      "刚运动完，身上还有汗味": "Just finished exercising and still smells sweaty",
      "天气太热，脖子上有汗": "Hot weather left sweat on their neck",
      "喝冰饮后嗓子有点哑": "Voice is a little hoarse after iced drinks",
      "最近花粉过敏": "Recent pollen allergy",
      "昨晚没睡好，眼神有点空": "Did not sleep well last night; eyes look blank",
      "嘴角像是上火破了一点": "Corner of mouth looks a bit irritated",
      "胃口不好，但说最近在控糖": "Poor appetite, but says they are cutting sugar",
      "咳嗽两声，说是空调吹多了": "Coughs twice and says the AC was too much",
      "新衣服标签磨得皮肤发红": "New clothing tag rubbed skin red",
      "健身拉伤，走路有点别扭": "Gym strain makes walking a bit awkward",
      "喝酒后脸和脖子容易泛红": "Face and neck flush easily after drinking",
      "最近加班，黑眼圈很重": "Recently working overtime with heavy dark circles",
      "说自己最近压力大，睡眠浅": "Says recent stress makes sleep light",
      "刚从外地回来，还在倒时差": "Just came back from out of town and is jet-lagged",
      "吃海鲜后皮肤有点痒": "Skin itches a little after eating seafood",
      "口腔破皮，说是牙套磨的": "Mouth scrape, says braces rubbed it",
      "运动后膝盖和肩膀酸": "Knees and shoulders ache after exercise",
      "感冒刚好，声音还有点鼻音": "Cold just passed; voice still sounds nasal",
      "最近晒太阳多，皮肤有点红": "Lots of sun recently, skin is a bit red",
      "减脂期吃得少，看起来偏瘦": "Eating little while cutting fat; looks thin",
      "穿得很严实，说是怕冷": "Dressed very covered-up, says they get cold",
      "朋友圈多是工作和运动": "Social feed is mostly work and exercise",
      "聊天时会认真听完你的担心": "Listens carefully to your concerns in chat",
      "提前问你能不能接受慢一点": "Asks in advance whether a slower pace is okay",
      "主动确认你的边界": "Proactively confirms your boundaries",
      "不催你马上做决定": "Does not rush you to decide immediately",
      "说可以先聊清楚再继续": "Says you can talk things through before continuing",
      "生活节奏看起来很稳定": "Life rhythm looks stable",
      "手机日程里排着运动和工作": "Phone calendar is filled with workouts and work",
      "房间里有书和运动装备": "Room has books and workout gear",
      "外卖记录大多是正常餐食": "Food delivery records are mostly normal meals",
      "很自然地提到最近体检": "Naturally mentions a recent checkup",
      "没有回避安全措施话题": "Does not avoid safety-measure topics",
      "说不舒服就可以随时停": "Says you can stop anytime if uncomfortable",
      "对陌生社交软件不太熟": "Not very familiar with stranger social apps",
      "社交圈看起来比较固定": "Social circle looks fairly fixed",
      "聊天内容更多是生活和兴趣": "Chat focuses more on life and interests",
      "不拿情史当谈资": "Does not use dating history as a bragging topic",
      "说最近主要忙工作和休息": "Says they are mostly busy with work and rest lately",
      "会主动保持合适距离": "Proactively keeps an appropriate distance",
      "约会前确认了你的时间安排": "Confirmed your schedule before the date",
      "说今天可以只散步聊天": "Says today can just be a walk and chat",
      "对安全套品牌和尺寸有准备": "Prepared condom brands and sizes",
      "没有劝你喝太多酒": "Does not push you to drink too much",
      "愿意把灯打开好好沟通": "Willing to turn on the lights and talk clearly",
      "对健康问题没有明显防御": "Does not get defensive about health questions",
      "说不确定就先别推进": "Says if you are unsure, do not push forward yet",
      "聊天中没有贬低你的谨慎": "Does not belittle your caution in chat",
      "能接受你临时改变主意": "Can accept you changing your mind at the last minute",
      "把检测和边界当成正常话题": "Treats testing and boundaries as normal topics",
      "周末常去爬山": "Often hikes on weekends",
      "喜欢游泳": "Likes swimming",
      "坚持瑜伽": "Practices yoga",
      "经常骑行": "Cycles often",
      "饭后会散步": "Takes walks after meals",
      "不喜欢夜店": "Dislikes nightclubs",
      "很少参加酒局": "Rarely attends drinking parties",
      "随身带消毒湿巾": "Carries disinfecting wipes",
      "进门先洗手": "Washes hands after entering",
      "床品看起来刚换过": "Bed linens look freshly changed",
      "洗漱用品分开放": "Toiletries are kept separate",
      "毛巾和浴巾分开放": "Towels and bath towels are kept separate",
      "指甲修剪整齐": "Nails are neatly trimmed",
      "身上没有异味": "No body odor",
      "鞋柜和衣柜很有秩序": "Shoe cabinet and wardrobe are orderly",
      "有独立牙刷杯": "Has an individual toothbrush cup",
      "洗手台很整洁": "Sink is tidy",
      "垃圾桶及时清理": "Trash is cleared promptly",
      "常备基础药品但不过度用药": "Keeps basic medicine but does not overuse it",
      "随身带着未拆封的安全套": "Carries unopened condoms",
      "愿意把灯打开，不躲避观察": "Willing to turn the lights on and not avoid being observed",
      "不拿“干净”开玩笑，而是认真谈保护": "Does not joke about being 'clean'; talks protection seriously",
      "愿意先聊天再决定": "Willing to chat first before deciding",
      "会主动确认你是否愿意": "Actively confirms whether you are willing",
      "会看安全套有效期": "Checks condom expiration date",
      "提到窗口期时没有表现出不耐烦": "Does not seem impatient when the testing window period is mentioned",
      "社交软件动态很少": "Social-app activity is sparse",
      "和朋友关系稳定": "Stable friendships",
      "说话不油腻": "Does not talk sleazily",
      "不用甜言蜜语施压": "Does not use sweet talk to pressure you",
      "不用激将法": "Does not use provocation",
      "你说慢一点，对方立刻停下": "When you say slow down, they stop immediately",
      "不把检查当成冒犯": "Does not treat checkups as offensive",
      "不制造“今晚必须”的压力": "Does not create pressure that tonight must happen",
      "让你先确认安全感": "Lets you confirm your sense of safety first",
      "皮肤状态很干净": "Skin looks clean",
      "说最近在调整作息": "Says they are adjusting their routine lately",
      "冰箱里都是正常食物": "Fridge is full of ordinary food",
      "包里有未拆封口罩和湿巾": "Bag has unopened masks and wet wipes",
      "最近在备赛或训练": "Recently preparing for a race or training",
      "职业防护习惯很强": "Strong occupational protection habits",
      "值班后先洗手消毒再靠近": "Washes and disinfects hands after a shift before coming closer",
      "能清楚解释检测窗口期": "Can clearly explain the testing window period",
      "体检记录整理得很完整": "Checkup records are well organized",
      "训练记录和作息都很规律": "Training records and routine are regular",
      "比赛前刚做过队内体检": "Had a team checkup before the competition",
      "演出前的身体检查刚结束": "Body check before the performance just finished",
      "飞行体检记录日期很近": "Flight physical record date is recent",
      "出差前刚完成单位体检": "Completed workplace checkup before the business trip",
      "长期固定作息，很少临时赴约": "Long-term fixed routine; rarely agrees to sudden dates",
      "社交圈很固定，最近很少约见陌生人": "Social circle is fixed; rarely meets strangers recently",
      "工作室里贴着卫生消毒流程": "Studio has posted hygiene disinfection procedures",
      "演出后台常备个人卫生用品": "Backstage personal hygiene supplies are always stocked",
      "旅行前后都有做常规体检": "Routine checkups before and after travel",
      "约会前主动说明最近身体状态正常": "Proactively explains recent physical condition is normal before the date",
      "说可以先聊天，不需要今晚推进": "Says you can chat first and do not need to push tonight",
      "没有回避你的边界问题": "Does not avoid your boundary questions",
      "愿意把社交软件动态给你看": "Willing to show you social-app activity",
      "运动员体检刚通过": "Athlete checkup just passed",
      "健身教练训练记录完整": "Fitness coach has complete training records",
      "瑜伽老师作息很稳定": "Yoga teacher has a stable routine",
      "舞蹈生近期刚做演出体检": "Dance student recently had a performance physical",
      "空乘体检记录日期很近": "Flight attendant checkup record date is recent",
      "飞行员定期体检合格": "Pilot passes regular physicals",
      "医学生知道检测窗口期": "Medical student knows the testing window period",
      "护士职业防护习惯很强": "Nurse has strong occupational protection habits",
      "医生能清楚解释检测流程": "Doctor can clearly explain the testing process",
      "牙医很注意消毒流程": "Dentist pays close attention to disinfection procedures",
      "游泳教练有规律训练安排": "Swimming coach has a regular training schedule",
      "拳击教练赛前体检正常": "Boxing coach had a normal pre-match physical",
      "徒步领队健康记录完整": "Hiking leader has complete health records",
      "旅游博主旅行前后会体检": "Travel blogger gets checkups before and after trips",
      "纹身师工作室消毒流程清楚": "Tattoo artist's studio disinfection process is clear"
    }
  };
  ...
  const els = {
    ...
    probeMeta: document.querySelector("#btn-chat small"),
  ...
  function setLanguage(nextLanguage) {
    ...
    if (els.rulesButton) {
      const rulesTitle = t("helpTitle") || (language === "zh" ? "玩法说明" : "How to play");
      els.rulesButton.title = rulesTitle;
      els.rulesButton.setAttribute("aria-label", rulesTitle);
    }
  ...
  function renderButtons() {
    ...
    if (els.probeMeta) {
      els.probeMeta.textContent = state.calmBoost ? t("probeBoostMeta") : t("probeMeta");
    }
  ...
  function applyDesireGuardIfNeeded(silent = false) {
    if (state.desire < 100 || state.desireGuardUsed) return false;
    state.desireGuardUsed = true;
    state.desire = DESIRE_GUARD_VALUE;
    if (!silent) showToast(t("desireGuardToast"));
    return true;
  }

  function applyCorrectDecisionReward() {
    state.correctStreak += 1;
    if (state.correctStreak < 2) return false;
    state.correctStreak = 0;
    state.calmBoost = true;
    return true;
  }

  function resetCorrectDecisionStreak() {
    state.correctStreak = 0;
  }

  function isProtectedAction(actionType) {
    return actionType === "light" || actionType === "steady";
  }

  function isUnprotectedAction(actionType) {
    return actionType === "shortcut" || actionType === "rush";
  }
  ...
  function takeFieldTest() {
    ...
    if (hasDiseaseRisk(riskProfile)) {
      ...
      state.load = clamp(state.load - 6, 0, 100);
      recordToolHistory("test", t("fieldTestRiskOutcome"), riskProfile);
      const boostUnlocked = applyCorrectDecisionReward();
      showToast(boostUnlocked ? `${t("fieldTestRiskToast")} ${t("calmBoostReady")}` : t("fieldTestRiskToast"));
    } else {
  ...
  function takeHospitalCheck() {
    ...
    state.desire = clamp(state.desire + HOSPITAL_DESIRE_COST, 0, 100);
    state.load = 0;
    revealAllHiddenTags();
  ...
  function takeProbeAction() {
    ...
    const desireCost = state.calmBoost ? PROBE_BOOST_DESIRE_COST : PROBE_DESIRE_COST;
    state.desire = clamp(state.desire + desireCost, 0, 100);
    if (state.calmBoost) {
      state.calmBoost = false;
      showToast(t("calmBoostUsed"));
    }
    revealOneHiddenTag();
  ...
  function takeSkipAction() {
    ...
    if (outcome === "正确离开") {
      state.desire = clamp(state.desire + 3, 0, 100);
      state.load = clamp(state.load - 6, 0, 100);
      if (applyCorrectDecisionReward()) rewardNotes.push(t("correctStreakNote"));
    } else {
      state.desire = clamp(state.desire + 6, 0, 100);
      state.load = clamp(state.load + 2, 0, 100);
      resetCorrectDecisionStreak();
    }

    if (applyDesireGuardIfNeeded(true)) rewardNotes.push(t("desireGuardNote"));
    const afterStats = getStatSnapshot();
    state.history.push({
      avatar: state.currentDate.avatar,
      tags: cloneTags(state.currentDate.tags),
    ...
    if (checkEndAfterAction()) return;
    renderAll();
    showFeedback(buildRoundFeedback("skip", outcome, riskProfile, false, beforeStats, afterStats, rewardNotes));
  }
  ...
  function resolveSexualAction(actionType) {
    ...
    if (!gotRisk && state.currentDate.obviousHealthy && isProtectedAction(actionType) && outcome === "理智享受") {
      state.desire = clamp(state.desire - 2, 0, 100);
      state.load = clamp(state.load - 4, 0, 100);
      rewardNotes.push(t("healthyRewardNote"));
      if (applyCorrectDecisionReward()) rewardNotes.push(t("correctStreakNote"));
    } else {
      resetCorrectDecisionStreak();
    }
    ...
    renderAll();
    showFeedback(buildRoundFeedback(actionType, outcome, historyRiskProfile, gotRisk, beforeStats, getStatSnapshot(), rewardNotes));
  }
    ...
    const rewardHTML = rewardNotes.length
      ? `
          <div class="judgment-card reward-card">
            <span>${escapeHTML(language === "zh" ? "奖励反馈" : "Reward")}</span>
            ${rewardNotes.map((note) => `<p>${escapeHTML(note)}</p>`).join("")}
          </div>
        `
      : "";
    return {
      ...
      rebuild: () => buildRoundFeedback(actionType, outcome, riskProfile, gotRisk, beforeStats, afterStats, rewardNotes),
      message: `
  ...
  function bindEvents() {
    ...
    els.rulesButton?.addEventListener("click", () => els.help.classList.remove("hidden"));
