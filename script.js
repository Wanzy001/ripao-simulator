(function () {
  ...
  const I18N = {
    ...
    en: {
      ...
      calmBoostReady: "Two correct judgments in a row unlocked a calm bonus: the next probe only adds +1 desire.",
      calmBoostUsed: "Calm bonus used: this probe only added +1 desire.",
      healthyRewardNote: "Obviously healthy date + safer choice: comfort kicked in, reducing desire and mental load further.",
      correctStreakNote: "Two correct judgments in a row unlocked a calm bonus: the next probe raises desire less.",
